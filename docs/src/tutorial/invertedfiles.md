...
2. For any other distance — including `Dist.NormCosine()`, used below for sparse-vector search,
   ...
   [`pairiterator`](@ref InvertedFiles.pairiterator) method (see the last section), you can plug
