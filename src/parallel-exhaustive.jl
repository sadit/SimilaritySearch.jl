...
"""
    search(ex::ParallelExhaustiveSearch, q, res::AbstractKnnResult; minbatch=0, pools=nothing)
...
"""
function search(ex::ParallelExhaustiveSearch, q, res::AbstractKnnResult; minbatch=0, pools=nothing)
    dist = ex.dist
    elock = ex.lock
