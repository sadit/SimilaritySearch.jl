...
function runconfig(bs::BeamSearch, index::SearchGraph, q, res::KnnResult, context::SearchGraphContext)
    search(bs, index, context, q, res, index.hints; maxvisits = 4index.search_algo.maxvisits)
