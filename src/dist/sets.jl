...
export Jaccard, Dice, Intersection, CosineSet, RogersTanimoto
using Base.Order
...
```
"""
struct Intersection <: SemiMetric end

"""
    evaluate(::Intersection, a, b)
...
"""
struct CosineSet <: SemiMetric end

"""
    evaluate(::CosineSet, a, b)
