...
"""
	select_posting_lists(idx::AbstractInvertedFile, ctx::InvertedFileContext, q)

Fetches and prepares the involved posting lists to solve `q`
"""
function select_posting_lists(idx::AbstractInvertedFile, ctx::InvertedFileContext, q)
