...
# ╔═╡ 5e4c0a0b-41dd-4b7b-a53d-25c21b01908c
...
begin
	...
	h = hcat(qinverted,  [X[id_]' for (id_, dist_) in res]...)
...
# ╔═╡ 29dc4d38-253d-41fc-9d74-3b1e63a84d6f
svg_joinpathsplit__FILE__1assetsarrowupcircleoutline1svg = let
    import PlutoUI
    PlutoUI.LocalResource(joinpath(split(@__FILE__, '#')[1] * ".assets", "arrow-up-circle-outline 1.svg"))
end

# ╔═╡ 2bc3baaa-abff-4725-9249-bb7eb42bffdd
svg_joinpathsplit__FILE__1assetsarrowupcircleoutlinesvg = let
    import PlutoUI
    PlutoUI.LocalResource(joinpath(split(@__FILE__, '#')[1] * ".assets", "arrow-up-circle-outline.svg"))
end
